...
namespace MockData.WookieBooks
{
    public static class MockDataInitializer
    {
        public static void Initialize(IServiceProvider serviceProvider)
        {
            ...
            {
                var imageToByteArray = new ImageToByteArray();
                ...
                var books = new List<Book>
                {
                    new Book
                    {
                        ...
                        Author = "J.K. Rowling",
                        CoverImage = imageToByteArray.GetImageBytes("HarryPotter1.jpg"),
                        Price = 11.20m,
                        CreatedBy = hpUser,
                    },
                    new Book
                    {
                        ...
                        Author = "J.K. Rowling",
                        CoverImage = imageToByteArray.GetImageBytes("HarryPotter2.jpg"),
                        Price = 12.38m,
                        CreatedBy = hpUser,
                    },
                    new Book
                    {
                        ...
                        Author = "J.K. Rowling",
                        CoverImage =  imageToByteArray.GetImageBytes("HarryPotter3.jpg"),
                        Price = 12.38m,
                        CreatedBy = hpUser,
                    },
                    new Book
                    {
                        ...
                        Author = "J.K. Rowling",
                        CoverImage =  imageToByteArray.GetImageBytes("HarryPotter4.jpg"),
                        Price = 31.68m,
                        CreatedBy = hpUser,
                    },
                    new Book
                    {
                        ...
                        Author = "J.K. Rowling",
                        CoverImage =  imageToByteArray.GetImageBytes("HarryPotter5.jpg"),
                        Price = 15.84m,
                        CreatedBy = hpUser,
                    },
                    new Book
                    {
                        ...
                        Author = "J.K. Rowling",
                        CoverImage =  imageToByteArray.GetImageBytes("HarryPotter6.jpg"),
                        Price = 17.82m,
                        CreatedBy = hpUser,
                    },
                    new Book
                    {
                        ...
                        Author = "J.K. Rowling",
                        CoverImage =  imageToByteArray.GetImageBytes("HarryPotter7.jpg"),
                        Price = 17.82m,
                        CreatedBy = hpUser,
                    },
                    new Book
                    {
                        ...
                        CoverImage = imageToByteArray.GetImageBytes("stephen1.jpg"),
                        Price = 19.80m,
                        CreatedBy = shUser,
                    },
                    new Book
                    {
                        ...
                        Author = "Stephen W. Hawking",
                        CoverImage = imageToByteArray.GetImageBytes("stephen2.jpg"),
                        Price = 10.99m,
                        CreatedBy = shUser,
                    }
                    ,
                    new Book
                    {
                        ...
                        Author = "Stephen W. Hawking",
                        CoverImage = imageToByteArray.GetImageBytes("stephen3.jpg"),
                        Price = 10.99m,
                        CreatedBy = shUser,
                    }
                };
